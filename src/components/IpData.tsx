...
export default function IpData() {
    ...
    const countryFlagImgApi = 'https://cdn.jsdelivr.net/gh/ashhitch/ISO-country-flags-icons@master/src/flags/png/'
        ...
        >
            <Descriptions.Item label="IP">
                <div className="horizontal-center justify-between">
                    <a
                        href={`https://ip.sb/whois/${ipData.ip}`}
                        rel="noreferrer"
                        target="_blank"
                    >
                        {ipData.ip}
            ...
            <Descriptions.Item label="ISP">
                <div className="horizontal-center justify-between">
                    ...
                    <Button
                        ...
                        shape="circle"
                        icon={<SearchOutlined/>}
                        onClick={() => window.open(`https://google.com/search?q=${ipData.isp}`)}
                    />
                </div>
            </Descriptions.Item>
            ...
            <Descriptions.Item label="ASN">
                <a
                    href={`https://ip.sb/whois/${ipData.asn}`}
                    rel="noreferrer"
                    target="_blank"
                >
                    {ipData.asn}
            ...
            <Descriptions.Item label="Location">
                <div className="horizontal-center justify-between">
                    <div>
                        <img
                            src={!!ipData.country_code ? `${countryFlagImgApi}${ipData.country_code.toLowerCase()}.png` : ''}
                            alt=""
                            style={{
                                marginRight: 5,
                                width: 28,
                    ...
                    <Button
                        ...
                        onClick={() => window.open(`https://www.google.com/maps/place/${ipData.latitude},${ipData.longitude}/`)}
                    />
                </div>
            </Descriptions.Item>
        </Descriptions>
